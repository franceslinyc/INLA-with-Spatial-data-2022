...
The hyperparameters of the latent field that is non-Gaussian, 
...
is Gaussian. This can be done by putting Gaussian priors on the intercept and the parameter of the fixed effects. 
