...
The Markov assumption in the GMRFs results in a sparse precision matrix (with lots of elements $=0$). When a matrix is sparse, the computational cost tends also to be lower, allowing for faster computation. Recall that $x \sim N(0, Q = \Sigma^{-1})$ and 
