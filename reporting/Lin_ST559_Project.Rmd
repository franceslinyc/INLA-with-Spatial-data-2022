...
LGMs (latent Gaussian models) is an umbrella class that generalizes the large number of related additive and/or generalized linear models. Consider the generalized linear mixed model setup, for example,
...
Two data sets are considered. The `NY8` data set is areal data. 

...... is point-referenced (or geostatistical) data. 

Since the focus of this part of the project is on the use of `R-INLA` package, the details of the models used for each data set are briefly introduced here. 
...
### 5.1. A Spatial (Areal) Example of Leukemia Cases
